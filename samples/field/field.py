...
class FieldConfig(Config):
    """Configuration for training on Denmark LPIS dataset.
...
class FieldDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        if image_info["source"] != "coco":
            return super(FieldDataset, self).load_mask(image_id)
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "coco":
            ...
            super(FieldDataset, self).image_reference(image_id)
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        dataset_train.load_field(args.dataset, "train", year=args.year, auto_download=args.download)
        if args.year in '2014':
            dataset_train.load_field(args.dataset, "valminusminival", year=args.year, auto_download=args.download)
